...
class BMInterface {
    ...
    protected function load_game_attributes($game, $row) {
        ...
        if ($row['tournament_id'] == NULL) {
            ...
            $game->tournamentId = (int)$row['tournament_id'];
        }
        if ($row['tournament_round_number'] == NULL) {
            $game->tournamentRoundNumber = NULL;
        } else {
            $game->tournamentRoundNumber = (int)$row['tournament_round_number'];
        }
    }
...
NOWDOC;
            ...
            $paramArray = array(':player_id_1' => $playerId,
            ...
            return self::read_tourn_list_from_db_results($statement);
        } catch (Exception $e) {
            error_log(
     ...
     * @return array
     */
    protected function read_tourn_list_from_db_results($statement) {
        // Initialize the arrays
        $tournIdArray = array();
